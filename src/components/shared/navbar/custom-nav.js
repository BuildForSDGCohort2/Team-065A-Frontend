      ...
      <Container>
        <Row className="top-row">
          ...
          <Col sm={12} md={7} lg={5} className="text-center skewed-div">
            <div className="top-right">You are not logged in<span className="divider-span">|</span> </div>
            <div className="top-right"><img src="/images/user.png" alt="user" /><a href="/dashboard">My Account</a></div>
          </Col>
